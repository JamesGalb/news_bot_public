...
#from .spiders.defense_gov_press import DefenseGovPressSpider
...
class SpiderRunner():
    def __init__(self):
        self.SPIDER_LIST = [BLSGovSpider]
#        self.SPIDER_LIST = [
#            TwitterSpider, YoutubeSpider, DHSGovSpider, DonaldjtrumpSpider, CommerceGovSpider, DefenseGovSpider, DefenseGovPressSpider,
...
#            HHSGovBlogSpider, JusticeGovSpider, GOPSpider, CBPGovSpider, JointChiefsSpider, USUNGovSpider, OversightGovSpider, IGNetGovSpider,
#            TransportationGovSpider, TransportationGovBlogSpider, VAGovSpider, StateGovSpider, StateGovBriefingsSpider, FacebookSpider,
...
#Need to change Pipeline information
    def run_spiders(self):
        ...
        try:
            ...
            process = CrawlerProcess(settings={'SCRAPE_LIMIT': 3,
                                       'LOG_LEVEL': 'DEBUG',
